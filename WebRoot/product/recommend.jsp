...
<html>
  ...
  <div id="by-self-defined" style="padding:20px;margin:5px">
	...
	<tbody>
		<s:iterator value="#request['recommend']" id="recommend">
						<tr>
							...
							<td>		
								<button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#editModal<s:property value="#recommend.id"/>">
						          <%-- <span class="glyphicon glyphicon-pencil"></span> --%>编辑</button>
						      
								<button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#delModal<s:property value="#recommend.id"/>">
	...
	<!-- ================模态框 =========================-->
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title" id="myModalLabel">添加店铺精品</h4>
		      </div>
		      
		      <form class="form-horizontal" name="myForm" id="myForm" method="post" action="addRecommend.action">
		      <div class="modal-body">
		      <!-- 内容 -->
			   <table class="table table-striped" align="center">
						  <thead> <tr><th>明细</th></tr> </thead>
				<tr><td> 产品名 &nbsp;&nbsp;&nbsp;<input type="text" id="name" name="name" placeholder="请输入名称" onblur="mention1();" /></td></tr>
				<tr><td> 类型 &nbsp;&nbsp;&nbsp;<input type="text" name="type" placeholder="如：植物精油" /></td></tr>
			    <tr><td> 颜色 &nbsp;&nbsp;&nbsp;<input type="text" name="color" placeholder="如：红色或者不限" /></td></tr>
				<tr><td> 耗时 &nbsp;&nbsp;&nbsp;<input type="text" id="timeConsuming" name="timeConsuming" placeholder="输入整数" /> mins</td></tr> 
				<tr><td> 原价 &nbsp;&nbsp;&nbsp;<input type="text" name="prePrice" placeholder="输入整数" onblur="mention5();" /> RMB</td></tr> 
				<tr><td> 现价 &nbsp;&nbsp;&nbsp;<input type="text" name="price" placeholder="输入整数" onblur="mention6();"/> RMB </td></tr> 
				<tr><td> 服务 &nbsp;&nbsp;&nbsp;<input type="text" name="service" placeholder="如：剪发" /> </td></tr> 
		...
		<div class="modal fade" id="editModal<s:property value="#recommend.id"/>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		        <h4 class="modal-title" id="myModalLabel">编辑店铺精品</h4>
		      </div>
		      
		      <form class="form-horizontal" name="myForm2" id="myForm2" method="post" action="editRecommend.action">
		      <div class="modal-body">
		      <!-- 内容 -->
			   <table class="table table-striped" align="center">
						  <thead> <tr><th>明细</th></tr> </thead>
				...
				<tr><td> 原价 &nbsp;&nbsp;&nbsp;<input type="text" name="prePrice" value=<s:property value="#recommend.prePrice"/> /> RMB</td></tr> 
		...
		<div class="modal fade" id="delModal<s:property value="#recommend.id"/>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		        <h4 class="modal-title" id="myModalLabel">删除店铺精品</h4>
		      </div>
		      
		      <form class="form-horizontal" name="myForm3" id="myForm3" method="post" action="deleteRecommend.action">
		      <div class="modal-body">
		      <!-- 内容 -->
			   <table class="table table-striped" align="center">
				...
				<tr><td> 原价 &nbsp;&nbsp;&nbsp;<input type="text" readOnly="true" border=0 name="prePrice" value=<s:property value="#recommend.prePrice"/>  /> RMB</td></tr> 
		...
		function mention1(){
		var s1=document.myForm.name.value;
			if(s1==null || s1=="") {myForm.name.focus();}
		};
		
		function mention5(){
		var s5=document.myForm.prePrice.value;
			if(isNaN(s5)|| s5==null || s5=="") {myForm.prePrice.focus();}
		};
		function mention6(){
		var s6=document.myForm.price.value;
			if(isNaN(s6)|| s6==null || s6=="") {myForm.price.focus();}
		};
