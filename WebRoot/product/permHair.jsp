		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title" id="myModalLabel">添加烫发产品</h4>
		      </div>
		      
		      <form class="form-horizontal"  method="post" action="addPermHair.action">
		      ...
		      <!-- 内容 -->
			   <table class="table table-striped" align="center">
				...
				<tr><td> 产品服务 &nbsp;&nbsp;&nbsp;烫发 <input type="hidden" readonly="true" name="service" value="烫发" /> </td></tr> 
				...
				<tr><td>
						...
						<option value="空气烫">空气烫</option>
						<option value="芭比烫">芭比烫</option>
						<option value="梨花烫">梨花烫</option>
						<option value="烟花烫">烟花烫</option>
						<option value="等离子烫">等离子烫</option>
				...
				<tr><td>
				    ...
				    <input type="text" placeholder="请输入颜色" name="color" />
				</td></tr>
		...
		<div class="modal fade" id="editModal<s:property value="#recommend.id"/>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		        <h4 class="modal-title" id="myModalLabel">编辑烫发产品</h4>
		      </div>
		      
		      <form class="form-horizontal" name="myForm2" id="myForm2" method="post" action="editPermHair.action">
		      <div class="modal-body">
		      <!-- 内容 -->
			   <table class="table table-striped" align="center">
		...
		<div class="modal fade" id="delModal<s:property value="#recommend.id"/>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		        <h4 class="modal-title" id="myModalLabel">删除染发</h4>
		      </div>
		      
		      <form class="form-horizontal" name="myForm3" id="myForm3" method="post" action="deletePermHair.action">
		      <div class="modal-body">
		      <!-- 内容 -->
			   <table class="table table-striped" align="center">
