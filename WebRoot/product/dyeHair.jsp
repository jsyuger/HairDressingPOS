		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title" id="myModalLabel">添加染发产品</h4>
		      </div>
		      
		      <form class="form-horizontal"  method="post" action="addDyeHair.action">
		      ...
		      <!-- 内容 -->
			   <table class="table table-striped" align="center">
				...
				<tr><td> 产品服务 &nbsp;&nbsp;&nbsp;染发 <input type="hidden" readonly="true" name="service" value="染发" /> </td></tr> 
				...
				<tr><td>
						...
						<option value="植物精华">植物精华</option>
						<option value="海洋精粹">海洋精粹</option>
		...
		<div class="modal fade" id="editModal<s:property value="#recommend.id"/>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		        <h4 class="modal-title" id="myModalLabel">编辑染发产品</h4>
		      </div>
		      
		      <form class="form-horizontal" name="myForm2" id="myForm2" method="post" action="editDyeHair.action">
		      <div class="modal-body">
		      <!-- 内容 -->
			   <table class="table table-striped" align="center">
		...
		<div class="modal fade" id="delModal<s:property value="#recommend.id"/>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		        <h4 class="modal-title" id="myModalLabel">删除烫发</h4>
		      </div>
		      
		      <form class="form-horizontal" name="myForm3" id="myForm3" method="post" action="deleteDyeHair.action">
		      <div class="modal-body">
		      <!-- 内容 -->
			   <table class="table table-striped" align="center">
