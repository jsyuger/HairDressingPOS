		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title" id="myModalLabel">添加剪发产品</h4>
		      </div>
		      
		      <form class="form-horizontal"  method="post" action="addCutHair.action">
		      ...
		      <!-- 内容 -->
			   <table class="table table-striped" align="center">
				...
				<tr><td> 产品服务 &nbsp;&nbsp;&nbsp;剪发 <input type="hidden" readonly="true" name="service" value="剪发" /> </td></tr> 
				<tr><td> 产品名 &nbsp;&nbsp;&nbsp;<input type="text" name="name" placeholder="请输入名称"></td></tr>
				<tr><td>
						<div style="position:relative;">
						类型 &nbsp;&nbsp;&nbsp;
						<span style="margin-left:100px;width:18px;overflow:hidden;">
						<select style="width:138px;margin-left:-100px" onchange="this.parentNode.nextSibling.value=this.value">
						<option value="普通精剪">普通精剪</option>
						<option value="个性化精剪">个性化精剪</option>
						<option value="普通洗剪吹">普通洗剪吹</option>
						<option value="个性化设计洗剪吹">个性化设计洗剪吹</option>
						</select></span><input name="type" style="width:120px;margin-left:50px;position:absolute;left:0px;">
						</div>
				     </td></tr>
		...
		<div class="modal fade" id="editModal<s:property value="#recommend.id"/>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		        <h4 class="modal-title" id="myModalLabel">编辑剪发产品</h4>
		      </div>
		      
		      <form class="form-horizontal" name="myForm2" id="myForm2" method="post" action="editCutHair.action">
		      <div class="modal-body">
		      <!-- 内容 -->
			   <table class="table table-striped" align="center">
		...
		<div class="modal fade" id="delModal<s:property value="#recommend.id"/>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		        <h4 class="modal-title" id="myModalLabel">删除剪发产品</h4>
		      </div>
		      
		      <form class="form-horizontal" name="myForm3" id="myForm3" method="post" action="deleteCutHair.action">
		      <div class="modal-body">
		      <!-- 内容 -->
			   <table class="table table-striped" align="center">
